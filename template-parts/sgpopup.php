...
<div id="bonus_popup" class="overlay dnone">
    <div class="popup">
        ...
        <div class="content">
                ...
                <div>
                    <p>
                        Nous n'envoyons <strong>pas de newsletter</strong>, nous ne <strong>commerçons pas avec vos données</strong> et nous ne vous enverrons <strong>pas d'e-mails réguliers</strong></br>
...
<script src="./Scripts/sgpopup.js"></script>